...
# Se remueven las claves por defecto para evitar filtraciones de seguridad en GitHub
TELEGRAM_TOKEN = os.getenv("8679048960:AAHbltsHK2Ed1OijAfMx4mqkk7RItDUPlf4")
